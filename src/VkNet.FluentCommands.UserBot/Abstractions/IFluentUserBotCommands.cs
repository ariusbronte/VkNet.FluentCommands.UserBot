...
namespace VkNet.FluentCommands.UserBot.Abstractions
{
    public interface IFluentGroupBotCommands
    {
        ...
        ///     Triggered if no matches are found or missing in the <see cref="VkNet.FluentCommands.UserBot.Storage.TextCommandsStore"/>.
        /// </summary>
        /// <remarks>Is not required.</remarks>
        /// <param name="handler">Handler logic.</param>
        /// <exception cref="System.ArgumentNullException">Thrown if handler is null.</exception>
        ...
        /// <exception cref="System.ArgumentException">Thrown if regular expression is null or whitespace.</exception>
        /// <exception cref="System.ArgumentNullException">Thrown if handler in null.</exception>
        void OnForward(string pattern, Func<IVkApi, Message, CancellationToken, Task> handler);
        ...
        /// <exception cref="System.ComponentModel.InvalidEnumArgumentException">Thrown if regex options is not defined.</exception>
        /// <exception cref="System.ArgumentNullException">Thrown if handler in null.</exception>
        void OnForward((string pattern, RegexOptions options) tuple, Func<IVkApi, Message, CancellationToken, Task> handler);
        ...
        /// <exception cref="System.ArgumentException">Thrown if regular expression is null or whitespace.</exception>
        /// <exception cref="System.ArgumentNullException">Thrown if handler in null.</exception>        
        void OnForward((long peerId, string pattern) tuple, Func<IVkApi, Message, CancellationToken, Task> handler);
        ...
        /// <exception cref="System.ComponentModel.InvalidEnumArgumentException">Thrown if regex options is not defined.</exception>
        /// <exception cref="System.ArgumentNullException">Thrown if handler in null.</exception>
        void OnForward((long peerId, string pattern, RegexOptions options) tuple, Func<IVkApi, Message, CancellationToken, Task> handler);

        /// <summary>
        ///     Global <c>NOT</c> extended handler of all incoming forward messages.
        ///     Triggered if no matches are found or missing in the <see cref="VkNet.FluentCommands.UserBot.Storage.ForwardCommandsStore"/>.
        /// </summary>
        /// <remarks>Is not required.</remarks>
        /// <remarks>Is an abstraction over the main handler.</remarks>
        /// <param name="answer">Text response.</param>
        ...
        ///     Triggered if no matches are found or missing in the <see cref="VkNet.FluentCommands.UserBot.Storage.AudioEventStore"/>.
        /// </summary>
        /// <remarks>Is not required.</remarks>
        /// <param name="handler">Handler logic.</param>
        /// <exception cref="System.ArgumentNullException">Thrown if handler is null.</exception>
        void OnAudio(Func<IVkApi, Message, CancellationToken, Task> handler);
        ...
        ///     Triggered if no matches are found or missing in the <see cref="VkNet.FluentCommands.UserBot.Storage.DocumentEventStore"/>.
        /// </summary>
        /// <remarks>Is not required.</remarks>
        /// <param name="handler">Handler logic.</param>
        /// <exception cref="System.ArgumentNullException">Thrown if handler is null.</exception>
        void OnDocument(Func<IVkApi, Message, CancellationToken, Task> handler);
